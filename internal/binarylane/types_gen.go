...
// Valid indicates whether the value is a known member of the AddDiskType enum.
func (e AddDiskType) Valid() bool {
	switch e {
	case AddDiskTypeAddDisk:
		return true
	default:
		return false
	}
...
// Valid indicates whether the value is a known member of the AdvancedFirewallRuleAction enum.
func (e AdvancedFirewallRuleAction) Valid() bool {
	switch e {
	case Accept:
		return true
	case Drop:
...
// Valid indicates whether the value is a known member of the AdvancedFirewallRuleProtocol enum.
func (e AdvancedFirewallRuleProtocol) Valid() bool {
	switch e {
	case All:
		return true
	case Icmp:
...
// Valid indicates whether the value is a known member of the AttachBackupType enum.
func (e AttachBackupType) Valid() bool {
	switch e {
	case AttachBackupTypeAttachBackup:
		return true
	default:
		return false
	}
...
// Valid indicates whether the value is a known member of the BackupReplacementStrategy enum.
func (e BackupReplacementStrategy) Valid() bool {
	switch e {
	case BackupReplacementStrategyNewest:
		return true
	case BackupReplacementStrategyNone:
		return true
	case BackupReplacementStrategyOldest:
		return true
	case BackupReplacementStrategySpecified:
		return true
	default:
		return false
	}
...
// Valid indicates whether the value is a known member of the BackupSlot enum.
func (e BackupSlot) Valid() bool {
	switch e {
	case Daily:
		return true
	case Monthly:
...
// Valid indicates whether the value is a known member of the ChangeAdvancedFeaturesType enum.
func (e ChangeAdvancedFeaturesType) Valid() bool {
	switch e {
	case ChangeAdvancedFeaturesTypeChangeAdvancedFeatures:
		return true
	default:
		return false
	}
...
// Valid indicates whether the value is a known member of the ChangeAdvancedFirewallRulesType enum.
func (e ChangeAdvancedFirewallRulesType) Valid() bool {
	switch e {
	case ChangeAdvancedFirewallRulesTypeChangeAdvancedFirewallRules:
		return true
	default:
		return false
	}
...
// Valid indicates whether the value is a known member of the ChangeBackupScheduleType enum.
func (e ChangeBackupScheduleType) Valid() bool {
	switch e {
	case ChangeBackupScheduleTypeChangeBackupSchedule:
		return true
	default:
		return false
	}
...
// Valid indicates whether the value is a known member of the ChangeIpv6Type enum.
func (e ChangeIpv6Type) Valid() bool {
	switch e {
	case ChangeIpv6TypeChangeIpv6:
		return true
	default:
		return false
	}
...
// Valid indicates whether the value is a known member of the ChangeIpv6ReverseNameserversType enum.
func (e ChangeIpv6ReverseNameserversType) Valid() bool {
	switch e {
	case ChangeIpv6ReverseNameserversTypeChangeIpv6ReverseNameservers:
		return true
	default:
		return false
	}
...
// Valid indicates whether the value is a known member of the ChangeKernelType enum.
func (e ChangeKernelType) Valid() bool {
	switch e {
	case ChangeKernelTypeChangeKernel:
		return true
	default:
		return false
	}
...
// Valid indicates whether the value is a known member of the ChangeManageOffsiteBackupCopiesType enum.
func (e ChangeManageOffsiteBackupCopiesType) Valid() bool {
	switch e {
	case ChangeManageOffsiteBackupCopiesTypeChangeManageOffsiteBackupCopies:
		return true
	default:
		return false
	}
...
// Valid indicates whether the value is a known member of the ChangeNetworkType enum.
func (e ChangeNetworkType) Valid() bool {
	switch e {
	case ChangeNetworkTypeChangeNetwork:
		return true
	default:
		return false
	}
...
// Valid indicates whether the value is a known member of the ChangeOffsiteBackupLocationType enum.
func (e ChangeOffsiteBackupLocationType) Valid() bool {
	switch e {
	case ChangeOffsiteBackupLocationTypeChangeOffsiteBackupLocation:
		return true
	default:
		return false
	}
...
// Valid indicates whether the value is a known member of the ChangePartnerType enum.
func (e ChangePartnerType) Valid() bool {
	switch e {
	case ChangePartnerTypeChangePartner:
		return true
	default:
		return false
	}
...
// Valid indicates whether the value is a known member of the ChangePortBlockingType enum.
func (e ChangePortBlockingType) Valid() bool {
	switch e {
	case ChangePortBlockingTypeChangePortBlocking:
		return true
	default:
		return false
	}
...
// Valid indicates whether the value is a known member of the ChangeRegionType enum.
func (e ChangeRegionType) Valid() bool {
	switch e {
	case ChangeRegionTypeChangeRegion:
		return true
	default:
		return false
	}
...
// Valid indicates whether the value is a known member of the ChangeReverseNameType enum.
func (e ChangeReverseNameType) Valid() bool {
	switch e {
	case ChangeReverseNameTypeChangeReverseName:
		return true
	default:
		return false
	}
...
// Valid indicates whether the value is a known member of the ChangeSeparatePrivateNetworkInterfaceType enum.
func (e ChangeSeparatePrivateNetworkInterfaceType) Valid() bool {
	switch e {
	case ChangeSeparatePrivateNetworkInterfaceTypeChangeSeparatePrivateNetworkInterface:
		return true
	default:
		return false
	}
...
// Valid indicates whether the value is a known member of the ChangeSourceAndDestinationCheckType enum.
func (e ChangeSourceAndDestinationCheckType) Valid() bool {
	switch e {
	case ChangeSourceAndDestinationCheckTypeChangeSourceAndDestinationCheck:
		return true
	default:
		return false
	}
...
// Valid indicates whether the value is a known member of the ChangeThresholdAlertsType enum.
func (e ChangeThresholdAlertsType) Valid() bool {
	switch e {
	case ChangeThresholdAlertsTypeChangeThresholdAlerts:
		return true
	default:
		return false
	}
...
// Valid indicates whether the value is a known member of the ChangeVpcIpv4Type enum.
func (e ChangeVpcIpv4Type) Valid() bool {
	switch e {
	case ChangeVpcIpv4TypeChangeVpcIpv4:
		return true
	default:
		return false
	}
...
// Valid indicates whether the value is a known member of the CloneUsingBackupType enum.
func (e CloneUsingBackupType) Valid() bool {
	switch e {
	case CloneUsingBackupTypeCloneUsingBackup:
		return true
	default:
		return false
	}
...
// Valid indicates whether the value is a known member of the DataInterval enum.
func (e DataInterval) Valid() bool {
	switch e {
	case Day:
		return true
	case FiveMinute:
...
// Valid indicates whether the value is a known member of the DeleteDiskType enum.
func (e DeleteDiskType) Valid() bool {
	switch e {
	case DeleteDiskTypeDeleteDisk:
		return true
	default:
		return false
	}
...
// Valid indicates whether the value is a known member of the DetachBackupType enum.
func (e DetachBackupType) Valid() bool {
	switch e {
	case DetachBackupTypeDetachBackup:
		return true
	default:
		return false
	}
...
// Valid indicates whether the value is a known member of the DisableBackupsType enum.
func (e DisableBackupsType) Valid() bool {
	switch e {
	case DisableBackupsTypeDisableBackups:
		return true
	default:
		return false
	}
...
// Valid indicates whether the value is a known member of the DisableSelinuxType enum.
func (e DisableSelinuxType) Valid() bool {
	switch e {
	case DisableSelinuxTypeDisableSelinux:
		return true
	default:
		return false
	}
...
// Valid indicates whether the value is a known member of the DistributionFeature enum.
func (e DistributionFeature) Valid() bool {
	switch e {
	case DistributionFeatureRemoteDesktop:
		return true
	case DistributionFeatureSsh:
		return true
	case DistributionFeatureUserData:
		return true
	default:
		return false
	}
...
// Valid indicates whether the value is a known member of the EnableBackupsType enum.
func (e EnableBackupsType) Valid() bool {
	switch e {
	case EnableBackupsTypeEnableBackups:
		return true
	default:
		return false
	}
...
// Valid indicates whether the value is a known member of the EnableIpv6Type enum.
func (e EnableIpv6Type) Valid() bool {
	switch e {
	case EnableIpv6TypeEnableIpv6:
		return true
	default:
		return false
	}
...
// Valid indicates whether the value is a known member of the IsRunningType enum.
func (e IsRunningType) Valid() bool {
	switch e {
	case IsRunningTypeIsRunning:
		return true
	default:
		return false
	}
...
// Valid indicates whether the value is a known member of the LoadBalancerRuleProtocol enum.
func (e LoadBalancerRuleProtocol) Valid() bool {
	switch e {
	case Http:
		return true
	case Https:
...
// Valid indicates whether the value is a known member of the LoadBalancerStatus enum.
func (e LoadBalancerStatus) Valid() bool {
	switch e {
	case LoadBalancerStatusActive:
		return true
	case LoadBalancerStatusErrored:
		return true
	case LoadBalancerStatusNew:
		return true
	default:
		return false
	}
...
// Valid indicates whether the value is a known member of the PasswordRecoveryType enum.
func (e PasswordRecoveryType) Valid() bool {
	switch e {
	case Manual:
		return true
	case OfflineChange:
...
// Valid indicates whether the value is a known member of the PasswordResetType enum.
func (e PasswordResetType) Valid() bool {
	switch e {
	case PasswordResetTypePasswordReset:
		return true
	default:
		return false
	}
...
// Valid indicates whether the value is a known member of the PingType enum.
func (e PingType) Valid() bool {
	switch e {
	case PingTypePing:
		return true
	default:
...
// Valid indicates whether the value is a known member of the PowerCycleType enum.
func (e PowerCycleType) Valid() bool {
	switch e {
	case PowerCycleTypePowerCycle:
		return true
	default:
		return false
	}
...
// Valid indicates whether the value is a known member of the PowerOffType enum.
func (e PowerOffType) Valid() bool {
	switch e {
	case PowerOffTypePowerOff:
		return true
	default:
		return false
	}
...
// Valid indicates whether the value is a known member of the PowerOnType enum.
func (e PowerOnType) Valid() bool {
	switch e {
	case PowerOnTypePowerOn:
		return true
	default:
		return false
	}
...
// Valid indicates whether the value is a known member of the RebuildType enum.
func (e RebuildType) Valid() bool {
	switch e {
	case RebuildTypeRebuild:
		return true
	default:
		return false
	}
...
// Valid indicates whether the value is a known member of the RenameType enum.
func (e RenameType) Valid() bool {
	switch e {
	case RenameTypeRename:
		return true
	default:
		return false
	}
...
// Valid indicates whether the value is a known member of the ResizeType enum.
func (e ResizeType) Valid() bool {
	switch e {
	case ResizeTypeResize:
		return true
	default:
		return false
	}
...
// Valid indicates whether the value is a known member of the ResizeDiskType enum.
func (e ResizeDiskType) Valid() bool {
	switch e {
	case ResizeDiskTypeResizeDisk:
		return true
	default:
		return false
	}
...
func (e ResourceType) Valid() bool {
	...
	case ResourceTypeLoadBalancer:
		return true
	case ResourceTypeRegisteredDomainName:
		return true
...
// Valid indicates whether the value is a known member of the RestoreType enum.
func (e RestoreType) Valid() bool {
	switch e {
	case RestoreTypeRestore:
		return true
	default:
		return false
	}
...
// Valid indicates whether the value is a known member of the ShutdownType enum.
func (e ShutdownType) Valid() bool {
	switch e {
	case ShutdownTypeShutdown:
		return true
	default:
		return false
	}
...
// Valid indicates whether the value is a known member of the TakeBackupType enum.
func (e TakeBackupType) Valid() bool {
	switch e {
	case TakeBackupTypeTakeBackup:
		return true
	default:
		return false
	}
...
// Valid indicates whether the value is a known member of the TaxCodeType enum.
func (e TaxCodeType) Valid() bool {
	switch e {
	case TaxCodeTypeNone:
		return true
	case TaxCodeTypeScalar:
		return true
	default:
		return false
	}
...
func (e ThresholdAlertType) Valid() bool {
	switch e {
	case Cpu:
		return true
...
// Valid indicates whether the value is a known member of the UncancelType enum.
func (e UncancelType) Valid() bool {
	switch e {
	case UncancelTypeUncancel:
		return true
	default:
		return false
	}
...
// Valid indicates whether the value is a known member of the UptimeType enum.
func (e UptimeType) Valid() bool {
	switch e {
	case UptimeTypeUptime:
		return true
	default:
		return false
	}
...
// Valid indicates whether the value is a known member of the UserInteractionType enum.
func (e UserInteractionType) Valid() bool {
	switch e {
	case AllowUncleanPowerOff:
		return true
	case ContinueAfterPingFailure:
		return true
	default:
		return false
	}
...
// Valid indicates whether the value is a known member of the VideoDevice enum.
func (e VideoDevice) Valid() bool {
	switch e {
	case CirrusLogic:
		return true
	case Standard:
...
func (e VmMachineType) Valid() bool {
	switch e {
	case PcI440fx1point5:
		return true
	case PcI440fx2point11:
		return true
	case PcI440fx4point1:
		return true
	case PcI440fx4point2:
		return true
	case PcI440fx5point0:
		return true
	case PcI440fx5point1:
		return true
...
type Action struct {
	...
	BlockingInvoiceId *int64 `json:"blocking_invoice_id,omitempty"`
...
type AdvancedFirewallRule struct {
	...
	DestinationPorts *[]string `json:"destination_ports,omitempty" tfsdk:"destination_ports"`
...
type AdvancedServerFeatures struct {
	...
	ProcessorModel *int64 `json:"processor_model,omitempty"`
...
type AttachedBackup struct {
	...
	AttachmentExpires *time.Time `json:"attachment_expires,omitempty"`
...
type BackupSettings struct {
	...
	OffsiteBackupSettings *OffsiteBackupSettings `json:"offsite_backup_settings,omitempty"`
}
...
type ChangeAdvancedFeatures struct {
	...
	AutomaticMachineType *bool `json:"automatic_machine_type,omitempty"`
	...
	AutomaticProcessorModel *bool `json:"automatic_processor_model,omitempty"`
...
type ChangeOffsiteBackupLocation struct {
	...
	OffsiteBackupLocation *string                         `json:"offsite_backup_location,omitempty"`
...
type ChangePartner struct {
	...
	PartnerServerId *int64            `json:"partner_server_id,omitempty"`
...
type ChangeSizeOptionsRequest struct {
	...
	Ipv4Addresses *int32 `json:"ipv4_addresses,omitempty"`
	...
	Ipv4AddressesToRemove *[]string `json:"ipv4_addresses_to_remove,omitempty"`
...
type CreateLoadBalancerRequest struct {
	...
	ForwardingRules *[]ForwardingRuleRequest `json:"forwarding_rules,omitempty" tfsdk:"forwarding_rules"`
...
type CreateServerRequest struct {
	...
	Options *SizeOptionsRequest `json:"options,omitempty"`
	...
	VpcIpv4Address *string `json:"vpc_ipv4_address,omitempty"`
}
...
type CreateVpcRequest struct {
	...
	RouteEntries *[]RouteEntryRequest `json:"route_entries,omitempty"`
}
...
type DistributionInfo struct {
	...
	RemoteAccessUser *string `json:"remote_access_user,omitempty" tfsdk:"remote_access_user"`
}
...
type DistributionSurcharges struct {
	...
	SurchargeBaseCost *float64 `json:"surcharge_base_cost,omitempty" tfsdk:"surcharge_base_cost"`

	// SurchargeMinVcpu The minimum vcpu count for surcharge calculations.
	SurchargeMinVcpu *int32 `json:"surcharge_min_vcpu,omitempty" tfsdk:"surcharge_min_vcpu"`
	...
	SurchargePerMemoryMaxMegabytes *int32 `json:"surcharge_per_memory_max_megabytes,omitempty" tfsdk:"surcharge_per_memory_max_megabytes"`

	// SurchargePerMemoryMegabyte The additional cost per MB for using this operating system as the base image for a size.
	SurchargePerMemoryMegabyte *float64 `json:"surcharge_per_memory_megabyte,omitempty" tfsdk:"surcharge_per_memory_megabyte"`

	// SurchargePerVcpu The additional cost per vcpu for using this operating system as the base image for a size.
	SurchargePerVcpu *float64 `json:"surcharge_per_vcpu,omitempty" tfsdk:"surcharge_per_vcpu"`
}
...
type Image struct {
	...
	BackupInfo *BackupInfo `json:"backup_info,omitempty" tfsdk:"backup_info"`

	// CreatedAt If this is a backup image this is the date and time in ISO8601 format when the image was created.
	CreatedAt *time.Time `json:"created_at,omitempty" tfsdk:"created_at"`
	...
	Distribution *string `json:"distribution,omitempty" tfsdk:"distribution"`
	...
	DistributionSurcharges *DistributionSurcharges `json:"distribution_surcharges,omitempty" tfsdk:"distribution_surcharges"`
	...
	MinMemoryMegabytes *int32 `json:"min_memory_megabytes,omitempty" tfsdk:"min_memory_megabytes"`
...
type Invoice struct {
	...
	PaymentFailureCount *int32 `json:"payment_failure_count,omitempty"`
...
type Network struct {
	...
	NatTarget *string `json:"nat_target,omitempty"`

	// Netmask The netmask for this network.
	Netmask *Network_Netmask `json:"netmask,omitempty"`
...
type Networks struct {
	...
	SourceAndDestinationCheck *bool `json:"source_and_destination_check,omitempty"`
...
type OffsiteBackupSettings struct {
	...
	ManageOffsiteCopies *bool `json:"manage_offsite_copies,omitempty"`
...
type Resize struct {
	...
	ChangeImage *ChangeImage `json:"change_image,omitempty"`
	...
	ChangeLicenses *ChangeLicenses `json:"change_licenses,omitempty"`
	...
	Options *ChangeSizeOptionsRequest `json:"options,omitempty"`

	// PreActionBackup Specify this to create a backup before any actions are taken, or leave null to skip.
	PreActionBackup *TakeBackup `json:"pre_action_backup,omitempty"`
...
type SampleSetResponse struct {
	SampleSet *SampleSet `json:"sample_set,omitempty"`
}
...
type Server struct {
	...
	AttachedBackup *AttachedBackup `json:"attached_backup,omitempty"`
	...
	SelectedSizeOptions *SelectedSizeOptions `json:"selected_size_options,omitempty"`
...
type Size struct {
	...
	CpuDescription *string `json:"cpu_description,omitempty" tfsdk:"cpu_description"`
	...
	RegionsOutOfStock *[]string `json:"regions_out_of_stock,omitempty" tfsdk:"regions_out_of_stock"`
	...
	StorageDescription *string `json:"storage_description,omitempty" tfsdk:"storage_description"`
...
type SizeOptions struct {
	...
	RestrictedDiskValues *[]int32 `json:"restricted_disk_values,omitempty" tfsdk:"restricted_disk_values"`
	...
	// TransferMax The maximum transfer in TB permitted for this size. If this is the same as `transfer` no additional transfer is supported.
...
type TakeBackup struct {
	...
	BackupIdToReplace *int64 `json:"backup_id_to_replace,omitempty"`
	...
	// | temporary | A backup which is created on demand and only retained for a maximum of seven days. |
	//
	BackupType *BackupSlot `json:"backup_type,omitempty"`
...
type UpdateLoadBalancerRequest struct {
	// ForwardingRules The rules that control which traffic the load balancer will forward to servers in the pool. Leave null to accept a default "HTTP" only forwarding rule.
	ForwardingRules *[]ForwardingRuleRequest `json:"forwarding_rules,omitempty"`
