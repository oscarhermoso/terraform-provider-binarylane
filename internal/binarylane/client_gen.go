...
func NewDeleteAccountKeysKeyIdRequest(server string, keyId int) (*http.Request, error) {
	...
	pathParam0, err = runtime.StyleParamWithOptions("simple", false, "key_id", keyId, runtime.StyleParamOptions{ParamLocation: runtime.ParamLocationPath, Type: "integer", Format: ""})
	if err != nil {
		return nil, err
	}
...
func NewGetActionsActionIdRequest(server string, actionId int64) (*http.Request, error) {
	...
	pathParam0, err = runtime.StyleParamWithOptions("simple", false, "action_id", actionId, runtime.StyleParamOptions{ParamLocation: runtime.ParamLocationPath, Type: "integer", Format: "int64"})
	if err != nil {
		return nil, err
	}
...
func NewGetCustomersMyInvoicesInvoiceIdRequest(server string, invoiceId int64) (*http.Request, error) {
	...
	pathParam0, err = runtime.StyleParamWithOptions("simple", false, "invoice_id", invoiceId, runtime.StyleParamOptions{ParamLocation: runtime.ParamLocationPath, Type: "integer", Format: "int64"})
	if err != nil {
		return nil, err
	}
...
func NewGetDataUsagesServerIdCurrentRequest(server string, serverId int64) (*http.Request, error) {
	...
	pathParam0, err = runtime.StyleParamWithOptions("simple", false, "server_id", serverId, runtime.StyleParamOptions{ParamLocation: runtime.ParamLocationPath, Type: "integer", Format: "int64"})
	if err != nil {
		return nil, err
	}
...
func NewDeleteDomainsDomainNameRequest(server string, domainName struct {
	...
	pathParam0, err = runtime.StyleParamWithOptions("simple", false, "domain_name", domainName, runtime.StyleParamOptions{ParamLocation: runtime.ParamLocationPath, Type: "", Format: ""})
	if err != nil {
		return nil, err
	}
...
func NewDeleteDomainsDomainNameRecordsRecordIdRequest(server string, domainName struct {
	...
	pathParam1, err = runtime.StyleParamWithOptions("simple", false, "record_id", recordId, runtime.StyleParamOptions{ParamLocation: runtime.ParamLocationPath, Type: "integer", Format: "int64"})
	if err != nil {
		return nil, err
	}
...
func NewGetImagesImageIdOrSlugRequest(server string, imageIdOrSlug struct {
	...
	pathParam0, err = runtime.StyleParamWithOptions("simple", false, "image_id_or_slug", imageIdOrSlug, runtime.StyleParamOptions{ParamLocation: runtime.ParamLocationPath, Type: "", Format: ""})
	if err != nil {
		return nil, err
	}
...
func NewDeleteLoadBalancersLoadBalancerIdRequest(server string, loadBalancerId int64) (*http.Request, error) {
	...
	pathParam0, err = runtime.StyleParamWithOptions("simple", false, "load_balancer_id", loadBalancerId, runtime.StyleParamOptions{ParamLocation: runtime.ParamLocationPath, Type: "integer", Format: "int64"})
	if err != nil {
		return nil, err
	}
...
func NewGetSamplesetsServerIdRequest(server string, serverId int64, params *GetSamplesetsServerIdParams) (*http.Request, error) {
	...
	if params != nil {
		...
		if params.DataInterval != nil {
			...
			if queryFrag, err := runtime.StyleParamWithOptions("form", true, "data_interval", *params.DataInterval, runtime.StyleParamOptions{ParamLocation: runtime.ParamLocationQuery, Type: "", Format: ""}); err != nil {
				return nil, err
			} else if parsed, err := url.ParseQuery(queryFrag); err != nil {
				return nil, err
			} else {
...
func NewGetServersServerIdActionsActionIdRequest(server string, serverId int64, actionId int64) (*http.Request, error) {
	...
	pathParam1, err = runtime.StyleParamWithOptions("simple", false, "action_id", actionId, runtime.StyleParamOptions{ParamLocation: runtime.ParamLocationPath, Type: "integer", Format: "int64"})
	if err != nil {
		return nil, err
	}
...
func NewGetSizesRequest(server string, params *GetSizesParams) (*http.Request, error) {
	...
	if params != nil {
		...
		if params.ServerId != nil {
			...
			if queryFrag, err := runtime.StyleParamWithOptions("form", true, "server_id", *params.ServerId, runtime.StyleParamOptions{ParamLocation: runtime.ParamLocationQuery, Type: "integer", Format: "int64"}); err != nil {
				return nil, err
			} else if parsed, err := url.ParseQuery(queryFrag); err != nil {
				return nil, err
			} else {
		...
		if params.Image != nil {
			...
			if queryFrag, err := runtime.StyleParamWithOptions("form", true, "image", *params.Image, runtime.StyleParamOptions{ParamLocation: runtime.ParamLocationQuery, Type: "string", Format: ""}); err != nil {
				return nil, err
			} else if parsed, err := url.ParseQuery(queryFrag); err != nil {
				return nil, err
			} else {
...
func NewGetSoftwareOperatingSystemOperatingSystemIdOrSlugRequest(server string, operatingSystemIdOrSlug struct {
	...
	pathParam0, err = runtime.StyleParamWithOptions("simple", false, "operating_system_id_or_slug", operatingSystemIdOrSlug, runtime.StyleParamOptions{ParamLocation: runtime.ParamLocationPath, Type: "", Format: ""})
	if err != nil {
		return nil, err
	}
...
func NewGetSoftwareSoftwareIdRequest(server string, softwareId int64) (*http.Request, error) {
	...
	pathParam0, err = runtime.StyleParamWithOptions("simple", false, "software_id", softwareId, runtime.StyleParamOptions{ParamLocation: runtime.ParamLocationPath, Type: "integer", Format: "int64"})
	if err != nil {
		return nil, err
	}
...
func NewDeleteVpcsVpcIdRequest(server string, vpcId int64) (*http.Request, error) {
	...
	pathParam0, err = runtime.StyleParamWithOptions("simple", false, "vpc_id", vpcId, runtime.StyleParamOptions{ParamLocation: runtime.ParamLocationPath, Type: "integer", Format: "int64"})
	if err != nil {
		return nil, err
	}
...
func NewGetVpcsVpcIdMembersRequest(server string, vpcId int64, params *GetVpcsVpcIdMembersParams) (*http.Request, error) {
	...
	if params != nil {
		...
		if params.ResourceType != nil {
			...
			if queryFrag, err := runtime.StyleParamWithOptions("form", true, "resource_type", *params.ResourceType, runtime.StyleParamOptions{ParamLocation: runtime.ParamLocationQuery, Type: "", Format: ""}); err != nil {
				return nil, err
			} else if parsed, err := url.ParseQuery(queryFrag); err != nil {
				return nil, err
			} else {
